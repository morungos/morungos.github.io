...
If there is an area where artificial intelligence is truly impactful, it is in
economics. It is not for nothing that the Nobel prize-winning researchers who do
have associations with AI, both did so in economics. Both, indeed, also directly
challenged the views of people as ‘rational’. 

Why? Because the kind of automation that AI provides is specifically able to
reshape the economics of various markets. For example:

* **Art and literature.** When art is a rare human skill, it is relatively easy
  to value, based on both scarcity and cost of production. But generative AI has
  the potential to make the cost of production almost zero, and make the
  production at scale almost limitless. Can writers survive if AI starts
  generating entire books at no cost? Where this ends, we don’t yet know.
  Certainly, it is a direct threat of immediate concern to both artists and
  writers. And reasonably so, because it has the exact same potential to
  annihilate an economy that early streaming/file-sharing did for
  music[^FileSharing]. The risks here for artists and writers are existential
  today, not in some imagined future.

[^FileSharing]: The distinction is that, in this case, the parties stepping away
    from the market are the big powerful corporations, like Netflix. There is,
    therefore, potentially less room for a market restructuring like the one
    that created modern streaming services. And even there, the consequences of
    modern stream services on musical artists cannot be understated. The entire
    financial basis for the industry has changed, and that’s before AI got into
    it. https://www.businessinsider.com/how-do-musicians-make-money-2018-10?op=1

* **Intellectual property.** Both patents and copyrights are directly challenged
  by artificial intelligence. Can an AI be a ‘creator’? This is actively being
  tested legally. So far, the decisions are suggesting that no, an AI can only be
  a proxy for a human. However, protection of intellectual property is not the
  only factor. What if AI could write programs better than people? 

* **Influence.** As both Kahneman and Tversky, and Herb Simon, noted: people’s
  decisions are relatively simple to influence. Our biases are clear and
  predictable, at least as far as a population is concerned. Indeed, the existence
  of advertising depends on this.

However, the economic view also enables us to make a prediction. The impacts of
AI will be sharpest on those areas of the economy that are (a) expensive, (b)
routine, and (c) without terrifying consequences of failure. If a role is cheap,
complex, or risky, it is likely to be much more resistant to automation, at
least in the medium term. Perhaps it is not entirely surprising that those on
the sharpest end of automation have been financial advisors, journalists,
marketers, recruiters. Not truck drivers, builders, baristas, cops, lawyers,
CEOs, or politicians. At least, not yet. Although there may be aspects of any of
these that could easily and beneficially be automated without disasters. 

The Silicon Valley view is explicit: this is simply one form of Schumpeter’s
‘creative destruction’ and that it is part of the constant process of
revolutionizing systems and replacing them. It is, therefore, modernism. It is
also inevitable. And, therefore, any social consequences are somebody else’s
problem. 

Of these, the most intriguing is risk. Why is that risky roles are so much
harder to transform with artificial intelligence?
